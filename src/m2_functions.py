...
def turtle4():
    terrance = rg.SimpleTurtle()
    terrance.pen = rg.Pen('forest green', 15)
    terrance.speed = 20
    for i in  range(15):
        terrance.forward(i * 40)
        terrance.right(144)

def turtle5():
    batman = rg.SimpleTurtle()
    batman.pen = rg.Pen('black', 5)
    batman.speed = 5
    batman.draw_circle(75)
    superman = rg.SimpleTurtle()
    superman.pen = rg.Pen('red', 6)
    superman.speed = 15
    superman.draw_square(200)
